...
public class ChangeSceneInteraction : Interaction
{
    ...
    {
        var spawnPos = _characterSpawnPosition.position;
        var lookDir = _characterSpawnPosition.forward;
        SceneTransition.Instance.DoTransition(_targetScene,
            () => CharacterMovementController.Instance.Teleport(spawnPos, lookDir));
    }
